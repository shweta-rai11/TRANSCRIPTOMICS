...
CSV_SCRIPT = {
    "combined_cohort_summary.csv": "scripts/00_shared/03_normalize_batch.R",
    "internal_val_holdout_meta.csv": "scripts/00_shared/03_normalize_batch.R",
    "normalization_diagnostics.csv": "scripts/00_shared/03_normalize_batch.R",
    "dataset_gene_overlap.csv": "scripts/00_shared/03_dataset_gene_overlap_venn.R",
    "05d_interaction.log": "scripts/00_shared/05d_interaction_report.R",
    "DEG_summary.csv": "scripts/00_shared/05_dge.R",
    "DEG_array_weights.csv": "scripts/00_shared/05_dge.R",
    "DEG_female_significant.csv": "scripts/00_shared/05_dge.R",
    "DEG_male_significant.csv": "scripts/00_shared/05_dge.R",
    "DEG_treat_sensitivity.csv": "scripts/00_shared/05_dge.R",
    "DEG_sensitivity_combat_vs_batch.csv": "scripts/00_shared/05b_dge_sensitivity.R",
    "dge_enriched_terms_female.csv": "scripts/00_shared/05_dge.R",
    "dge_enriched_terms_male.csv": "scripts/00_shared/05_dge.R",
    "dge_enriched_terms_all.csv": "scripts/00_shared/05_dge.R",
    "gsea_kegg.csv": "scripts/00_shared/05_dge.R",
    "WGCNA_01_soft_threshold.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_02_module_trait.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_03_disease_modules.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_05_gene_module_assignment.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_06_disease_module_hubs.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_08_disease_GO.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_09_disease_KEGG.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_10_module_preservation.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_11_candidates_female.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_11_candidates_male.csv": "scripts/00_shared/06_WGCNA.R",
    "WGCNA_12_candidate_summary.csv": "scripts/00_shared/06_WGCNA.R",
    "06_WGCNA_run3.log": "scripts/00_shared/06_WGCNA.R",
    "module_trait_RAvsControl_ALLSTRATA.csv": "scripts/00_shared/08_module_trait_RA_control.R",
    "module_trait_RAvsControl_all.csv": "scripts/00_shared/08_module_trait_RA_control.R",
    "module_trait_RAvsControl_female.csv": "scripts/00_shared/08_module_trait_RA_control.R",
    "module_trait_RAvsControl_male.csv": "scripts/00_shared/08_module_trait_RA_control.R",
    "candidate_summary.csv": "scripts/00_shared/09_disease_module_deg_intersect.R",
    "candidates_female_disease.csv": "scripts/00_shared/09_disease_module_deg_intersect.R",
    "candidates_male_disease.csv": "scripts/00_shared/09_disease_module_deg_intersect.R",
    "disease_module_selection.csv": "scripts/00_shared/09_disease_module_deg_intersect.R",
    "diseasemod_DEG_direction_summary.csv": "scripts/00_shared/09b_disease_module_deg_venn.R",
    "diseasemod_DEG_intersection_female.csv": "scripts/00_shared/09b_disease_module_deg_venn.R",
    "diseasemod_DEG_intersection_male.csv": "scripts/00_shared/09b_disease_module_deg_venn.R",
    "MR_MHC_sensitivity_summary.csv": "scripts/00_shared/10c_MR_mhc_sensitivity.R",
    "MR_MHC_sensitivity_female.csv": "scripts/00_shared/10c_MR_mhc_sensitivity.R",
    "MR_MHC_sensitivity_male.csv": "scripts/00_shared/10c_MR_mhc_sensitivity.R",
    "MR_MHC_sensitivity_panel_fate.csv": "scripts/00_shared/10c_MR_mhc_sensitivity.R",
    "FS_input_female.csv": "scripts/00_shared/10_MR.R",
    "FS_input_male.csv": "scripts/00_shared/10_MR.R",
    "FS_input_female_noMHC.csv": "scripts/00_shared/10c_MR_mhc_sensitivity.R",
    "FS_input_male_noMHC.csv": "scripts/00_shared/10c_MR_mhc_sensitivity.R",
    "MR_female_TABLE1_instruments.csv": "scripts/00_shared/10_MR.R",
    "MR_male_TABLE1_instruments.csv": "scripts/00_shared/10_MR.R",
    "MR_female_TABLE2_results_allmethods.csv": "scripts/00_shared/10_MR.R",
    "MR_male_TABLE2_results_allmethods.csv": "scripts/00_shared/10_MR.R",
    "MR_female_TABLE3_pleiotropy.csv": "scripts/00_shared/10_MR.R",
    "MR_male_TABLE3_pleiotropy.csv": "scripts/00_shared/10_MR.R",
    "MR_female_TABLE4_heterogeneity.csv": "scripts/00_shared/10_MR.R",
    "MR_male_TABLE4_heterogeneity.csv": "scripts/00_shared/10_MR.R",
    "MR_female_primary_okada.csv": "scripts/00_shared/10_MR.R",
    "MR_male_primary_okada.csv": "scripts/00_shared/10_MR.R",
    "COLOC_results.csv": "scripts/00_shared/10d_coloc_panel_genes.R",
    "COLOC_panel_genes.csv": "scripts/00_shared/10d_coloc_panel_genes.R",
    "COLOC_summary.csv": "scripts/00_shared/10d_coloc_panel_genes.R",
    "COLOC_SUSIE_mhc.csv": "scripts/00_shared/10e_coloc_susie_mhc.R",
    "COLOC_combined_abf_susie.csv": "scripts/00_shared/10e_coloc_susie_mhc.R",
    "mr_fs_summary.csv": "scripts/goal2_sex_stratified/12_feature_selection.R",
    "mr_fs_consensus_female.csv": "scripts/goal2_sex_stratified/12_feature_selection.R",
    "mr_fs_consensus_male.csv": "scripts/goal2_sex_stratified/12_feature_selection.R",
    "mr_fs_selected_bymethod_female.csv": "scripts/goal2_sex_stratified/12_feature_selection.R",
    "mr_fs_selected_bymethod_male.csv": "scripts/goal2_sex_stratified/12_feature_selection.R",
    "mr_fs_summary_noMHC.csv": "scripts/goal2_sex_stratified/12b_feature_selection_noMHC.R",
    "PANEL_primary_vs_noMHC_membership.csv": "scripts/goal2_sex_stratified/12b_feature_selection_noMHC.R",
    "FS_venn_membership.csv": "scripts/goal2_sex_stratified/13_feature_selection_venn.R",
    "mr_nested_cv_stability_female.csv": "scripts/goal2_sex_stratified/14_model_training_nested_cv.R",
    "mr_nested_cv_stability_male.csv": "scripts/goal2_sex_stratified/14_model_training_nested_cv.R",
    "mr_nested_cv_summary.csv": "scripts/goal2_sex_stratified/14_model_training_nested_cv.R",
    "mr_elasticnet_summary.csv": "scripts/goal2_sex_stratified/15_model_training_elasticnet.R",
    "mr_final_coefs_bysex.csv": "scripts/goal2_sex_stratified/16_model_training_final_panel.R",
    "mr_final_panel_summary.csv": "scripts/goal2_sex_stratified/16_model_training_final_panel.R",
    "PANEL_primary_vs_noMHC_nestedcv.csv": "scripts/goal2_sex_stratified/16b_model_training_final_panel_noMHC.R",
    "PANEL_primary_vs_noMHC_delong.csv": "scripts/goal2_sex_stratified/16b_model_training_final_panel_noMHC.R",
    "PANEL_primary_vs_noMHC_performance.csv": "scripts/goal2_sex_stratified/16b_model_training_final_panel_noMHC.R",
    "nested_cv_stability_female.csv": "scripts/goal2_sex_stratified/16c_model_training_nested_cv_transcriptomewide.R",
    "nested_cv_stability_male.csv": "scripts/goal2_sex_stratified/16c_model_training_nested_cv_transcriptomewide.R",
    "nested_cv_summary.csv": "scripts/goal2_sex_stratified/16c_model_training_nested_cv_transcriptomewide.R",
    "NESTED_CV_AUTHORITATIVE.csv": "scripts/goal2_sex_stratified/16d_nested_cv_reconciliation.R",
    "NESTED_CV_legacy_reconciliation.csv": "scripts/goal2_sex_stratified/16d_nested_cv_reconciliation.R",
    "mr_roc_panel_auc.csv": "scripts/goal2_sex_stratified/17_testing_blood_internal_external.R",
    "mr_roc_pergene_auc.csv": "scripts/goal2_sex_stratified/17_testing_blood_internal_external.R",
    "PANEL_auc_celladjusted.csv": "scripts/goal2_sex_stratified/17b_testing_blood_celladjusted.R",
    "PANEL_incremental_value_LRT.csv": "scripts/goal2_sex_stratified/17b_testing_blood_celladjusted.R",
    "PANEL_auc_celladjusted_summary.csv": "scripts/goal2_sex_stratified/17b_testing_blood_celladjusted.R",
    "mr_pergene_train_auc.csv": "scripts/goal2_sex_stratified/18_testing_blood_pergene_roc.R",
    "diag_dca_female.csv": "scripts/goal2_sex_stratified/19_testing_blood_clinical_utility.R",
    "diag_dca_male.csv": "scripts/goal2_sex_stratified/19_testing_blood_clinical_utility.R",
    "19_testing_blood_clinical_utility.log": "scripts/goal2_sex_stratified/19_testing_blood_clinical_utility.R",
    "val_synovium_pergene_female.csv": "scripts/goal2_sex_stratified/20_testing_synovium_external.R",
    "val_synovium_pergene_male.csv": "scripts/goal2_sex_stratified/20_testing_synovium_external.R",
    "crosstissue_panel_auc.csv": "scripts/goal2_sex_stratified/22_crosstissue_biomarker_discovery.R",
    "pergene_auc_alltissues.csv": "scripts/goal2_sex_stratified/24_crosstissue_pergene_auc.R",
    "MR35_crossancestry_female.csv": "scripts/goal2_sex_stratified/26_crossancestry_biomarker_mr.R",
    "MR35_crossancestry_male.csv": "scripts/goal2_sex_stratified/26_crossancestry_biomarker_mr.R",
    "MR35_crossancestry_summary.csv": "scripts/goal2_sex_stratified/26_crossancestry_biomarker_mr.R",
    "MR35_instrument_transferability_female.csv": "scripts/goal2_sex_stratified/26_crossancestry_biomarker_mr.R",
    "MR35_instrument_transferability_male.csv": "scripts/goal2_sex_stratified/26_crossancestry_biomarker_mr.R",
    "CELL_fractions_train.csv": "scripts/00_shared/05c_deconvolution.R",
    "CELL_fractions_holdout.csv": "scripts/00_shared/05c_deconvolution.R",
    "CELL_fractions_external.csv": "scripts/00_shared/05c_deconvolution.R",
    "CELL_mcpcounter_train.csv": "scripts/00_shared/05c_deconvolution.R",
    "CELL_mcpcounter_external.csv": "scripts/00_shared/05c_deconvolution.R",
    "CELL_fraction_group_tests.csv": "scripts/00_shared/05c_deconvolution.R",
    "CELL_composition_pca.csv": "scripts/00_shared/05c_deconvolution.R",
    "CELL_panel_gene_adjustment.csv": "scripts/00_shared/05c_deconvolution.R",
    "DEG_celladjusted_female.csv": "scripts/00_shared/05c_deconvolution.R",
    "DEG_celladjusted_male.csv": "scripts/00_shared/05c_deconvolution.R",
    "DEG_celladjusted_summary.csv": "scripts/00_shared/05c_deconvolution.R",
    "DEG_interaction_summary.csv": "scripts/00_shared/05b_dge_sensitivity.R",
    "DEG_interaction_top.csv": "scripts/00_shared/05b_dge_sensitivity.R",
    "DEG_interaction_model_comparison.csv": "scripts/00_shared/05d_interaction_report.R",
    "DEG_interaction_full.csv": "scripts/00_shared/05d_interaction_report.R",
    "DEG_interaction_significant.csv": "scripts/00_shared/05d_interaction_report.R",
    "DEG_interaction_patterns.csv": "scripts/00_shared/05d_interaction_report.R",
    "DEG_interaction_enrichment.csv": "scripts/00_shared/05d_interaction_report.R",
    "enrich_GO_BP_female.csv": "scripts/goal2_sex_stratified/34_pathway_enrichment.R",
    "enrich_GO_BP_male.csv": "scripts/goal2_sex_stratified/34_pathway_enrichment.R",
    "enrich_KEGG_female.csv": "scripts/goal2_sex_stratified/34_pathway_enrichment.R",
    "enrich_KEGG_male.csv": "scripts/goal2_sex_stratified/34_pathway_enrichment.R",
}
